...
#
# baseSystem.tcl: Tcl script for re-creating project 'baseSystem'
#
# Generated by Vivado on Wed Aug 26 18:08:58 -05 2026
...
#
# 1. This project restoration tcl script (baseSystem.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/alberto/Xilinx/ZyboZ7-10/baseSystem/hardware/baseSystem/baseSystem.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/alberto/Xilinx/ZyboZ7-10/baseSystem/hardware/src/KypdDeco.sv"
#    "/home/alberto/Xilinx/ZyboZ7-10/baseSystem/hardware/src/KypdDecoVerilogWrapper.v"
#    "/home/alberto/Xilinx/ZyboZ7-10/baseSystem/hardware/bd/design_1/hdl/design_1_wrapper.v"
#    "/home/alberto/Xilinx/ZyboZ7-10/baseSystem/hardware/cons/constraints.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/baseSystem/baseSystem.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/src/KypdDeco.sv"]"\
 "[file normalize "$origin_dir/src/KypdDecoVerilogWrapper.v"]"\
 "[file normalize "$origin_dir/bd/design_1/hdl/design_1_wrapper.v"]"\
 "[file normalize "$origin_dir/cons/constraints.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set _xil_proj_name_ "baseSystem"
...
set script_file "baseSystem.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/baseSystem"]"
...
set_msg_config  -id {Synth 8-7071}  -new_severity {INFO}  -ruleid {1}  -source 2
set_msg_config  -id {Synth 8-7023}  -new_severity {INFO}  -ruleid {2}  -source 2
set_msg_config  -id {Synth 8-4446}  -new_severity {INFO}  -ruleid {3}  -source 2
set_msg_config  -id {Synth 8-7129}  -new_severity {INFO}  -ruleid {4}  -source 2
...
set file "$origin_dir/src/KypdDeco.sv"
...
set file "[file normalize "$origin_dir/cons/constraints.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/cons/constraints.xdc"
set file [file normalize $file]
...
set_property -name "top" -value "keypad_deco" -objects $obj
...
if { [get_files [list KypdDeco.sv]] == "" } {
  import_files -quiet -fileset sources_1 /home/alberto/Xilinx/ZyboZ7-10/baseSystem/hardware/src/KypdDeco.sv
}
if { [get_files [list KypdDecoVerilogWrapper.v]] == "" } {
  import_files -quiet -fileset sources_1 /home/alberto/Xilinx/ZyboZ7-10/baseSystem/hardware/src/KypdDecoVerilogWrapper.v
}
...
if {[string equal [get_runs -quiet synth_1_copy_1] ""]} {
    create_run -name synth_1_copy_1 -part xc7z010clg400-1 -flow {Vivado Synthesis 2025} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
