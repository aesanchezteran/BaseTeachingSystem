...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,da_board_cnt=4,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_analog_io:1.0 Vaux14_0 V_N" *) (* X_INTERFACE_MODE = "Slave" *) input Vaux14_0_v_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_analog_io:1.0 Vaux14_0 V_P" *) input Vaux14_0_v_p;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_analog_io:1.0 Vaux15_0 V_N" *) (* X_INTERFACE_MODE = "Slave" *) input Vaux15_0_v_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_analog_io:1.0 Vaux15_0 V_P" *) input Vaux15_0_v_p;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_analog_io:1.0 Vaux6_0 V_N" *) (* X_INTERFACE_MODE = "Slave" *) input Vaux6_0_v_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_analog_io:1.0 Vaux6_0 V_P" *) input Vaux6_0_v_p;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_analog_io:1.0 Vaux7_0 V_N" *) (* X_INTERFACE_MODE = "Slave" *) input Vaux7_0_v_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_analog_io:1.0 Vaux7_0 V_P" *) input Vaux7_0_v_p;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 btns_4bits TRI_I" *) (* X_INTERFACE_MODE = "Master" *) input [3:0]btns_4bits_tri_i;
  output busy_out_0;
  output [3:0]cols_0;
  input convst_in_0;
  output eoc_out_0;
  ...
  input [3:0]rows_0;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 sws_4bits TRI_I" *) (* X_INTERFACE_MODE = "Master" *) input [3:0]sws_4bits_tri_i;
  ...
  wire [10:0]axi_smc_M04_AXI_ARADDR;
  wire axi_smc_M04_AXI_ARREADY;
  wire axi_smc_M04_AXI_ARVALID;
  wire [10:0]axi_smc_M04_AXI_AWADDR;
  ...
  wire eoc_out_0;
  wire eos_out_0;
  wire [4:0]keypad_deco_0_key;
  wire [3:0]keypad_deco_0_state;
  wire keypad_deco_0_strb;
  wire [3:0]keypad_deco_0_sync_rows;
  wire keypad_deco_0_valid;
  ...
  design_1_ila_0_0 ila_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .probe0(cols_0),
        .probe1(rows_0),
        .probe2(keypad_deco_0_sync_rows),
        .probe3(keypad_deco_0_state),
        .probe4(keypad_deco_0_valid),
        .probe5(keypad_deco_0_strb),
        .probe6(keypad_deco_0_key));
  design_1_keypad_deco_0_0 keypad_deco_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .cols(cols_0),
        .key(keypad_deco_0_key),
        .rows(rows_0),
        .rstn(rst_ps7_0_100M_peripheral_aresetn),
        .state(keypad_deco_0_state),
        .strb(keypad_deco_0_strb),
        .sync_rows(keypad_deco_0_sync_rows),
        .valid(keypad_deco_0_valid));
  ...
  design_1_xadc_wiz_0_0 xadc_wiz_0
       (.busy_out(busy_out_0),
        ...
        .vauxn14(Vaux14_0_v_n),
        .vauxn15(Vaux15_0_v_n),
        .vauxn6(Vaux6_0_v_n),
        .vauxn7(Vaux7_0_v_n),
        .vauxp14(Vaux14_0_v_p),
        .vauxp15(Vaux15_0_v_p),
        .vauxp6(Vaux6_0_v_p),
        .vauxp7(Vaux7_0_v_p),
        .vn_in(1'b0),
        .vp_in(1'b0));
